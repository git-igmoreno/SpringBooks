...
Method: GET
>```
>http://localhost:8080/api/v1/authors/1
>```

⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃


## End-point: Add Author
### Description: 
Method: POST
>```
>http://localhost:8080/api/v1/authors
...
Method: PUT
>```
>http://localhost:8080/api/v1authors/1
>```
### Body (**raw**)
...
```json
{
    ...
    "picture":"Updated author picture URL"
}
```
...
## End-point: Register Book to Author
### Description: 
Method: POST
>```
>http://localhost:8080/api/v1/authors/1/books
>```
### Body (**raw**)
